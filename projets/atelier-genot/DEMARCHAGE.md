...
**Vos ouvrages restent visibles.** Sur le site, votre portail et votre plaque
en corten sont en page d'accueil en permanence. Ils ne descendent pas dans un
fil.

**Google peut enfin vous trouver.** Le site contient les informations
techniques qui associent l'Atelier Genot aux recherches locales — « ferronnier
près de Huy », « portail sur mesure Marchin ». C'est le travail invisible, et
c'est celui qui amène le téléphone à sonner.

**Un bouton « Demander un devis ».** Le visiteur décrit son projet, ses
dimensions, son délai — et la demande arrive dans votre boîte mail, déjà
rédigée. Vous ne perdez plus l'appel manqué du samedi après-midi.

**La confiance.** Quand quelqu'un s'apprête à commander un escalier ou un
portail à plusieurs milliers d'euros, il vérifie. Entre deux ateliers, celui
qui a un site rassure. C'est injuste, mais c'est ainsi.

**Votre numéro toujours à portée de pouce.** Sur téléphone, un bandeau
« Appeler » reste affiché en bas de l'écran, quelle que soit la page.

### Ce que je propose

| | |
|---|---|
| **Création du site** | **250 €**, une seule fois |
| **Abonnement annuel** | **50 € / an** — nom de domaine `atelier-genot.be`, hébergement et suivi |

Pas d'engagement de durée, pas de frais cachés, pas de commission sur vos
chantiers. Si vous arrêtez l'abonnement, le site vous reste : les fichiers sont
à vous.

Ce tarif est bas, et c'est volontaire : le site est déjà fait. Vous ne payez
pas des semaines de conception, vous payez la mise en service et le suivi.

**Ce qui est compris dans les 250 €**

- Le site tel que vous le voyez, ajusté à vos remarques
- L'intégration de vos photos supplémentaires
- La mise en ligne sur `atelier-genot.be`
- L'aide à la création de votre fiche Google — c'est elle qui vous fera
  apparaître sur la carte quand on cherche un ferronnier dans la région

**Ce qui est compris dans les 50 € / an**

- Le nom de domaine `atelier-genot.be`, renouvelé chaque année
- L'hébergement et le certificat de sécurité
- Les mises à jour de vos coordonnées, horaires et nouvelles réalisations

### Ce qu'il reste à faire ensemble

Le site est construit à partir de ce que dit votre page Facebook. Trois choses
demandent votre validation :

1. **Vos horaires réels** — Facebook indique « toujours ouvert », j'ai écrit
   7 h – 18 h en semaine.
2. **La liste de vos prestations** — j'y ai mis escaliers, garde-corps,
   portails, palissades, découpe décorative, structures et soudure. À corriger
   si j'ai ajouté ou oublié quelque chose.
3. **Votre numéro de TVA** — obligatoire en bas de page.

Et si vous avez des photos d'un escalier ou d'un garde-corps posé, elles
manquent : ce sont vos deux premières prestations et rien ne les illustre
encore.

### Le site reste en ligne jusqu'au 8 août

Passé cette date, le lien ne fonctionnera plus. Ce n'est pas une pression
commerciale : je ne laisse pas une démonstration ouverte indéfiniment.

Un mot en réponse à ce mail suffit — même « ça m'intéresse, expliquez-moi » ou
« non merci ». Je réponds à tout.
...
> Facebook est très bien pour montrer vos chantiers à ceux qui vous suivent
> déjà. Le site sert les autres : la personne qui tape « ferronnier Marchin »
> dans Google et qui ne vous connaît pas encore. Les deux ne se remplacent pas,
> ils se complètent — et le site alimente votre fiche Google, qui est ce qui
> vous fait apparaître sur la carte.

### « C'est combien déjà, et pourquoi si peu cher ? »
...
plus lent à écrire qu'un « +30 % de clients », mais c'est ce qui tient debout
