 ...
 *
 *   node build-embed.mjs            → atelier-genot.embed.html
 *
...
let css = readFileSync(p("assets/css/style.css"), "utf8")
  .replace('url("../fonts/genot-display.woff2")', `url("${dataUri(p("assets/fonts/genot-display.woff2"), "font/woff2")}")`)
  .replace('url("../fonts/genot-text.woff2")', `url("${dataUri(p("assets/fonts/genot-text.woff2"), "font/woff2")}")`);
...
/* --- Images -------------------------------------------------------------- */
const images = {
  "assets/img/accueil.jpg": photo("accueil.jpg", 1200, 62),
  "assets/img/realisation-1.jpg": photo("realisation-1.jpg", 820, 66),
  "assets/img/realisation-2.jpg": photo("realisation-2.jpg", 520, 66),
  "assets/img/realisation-3.jpg": photo("realisation-3.jpg", 560, 72),
  "assets/img/realisation-4.jpg": photo("realisation-4.jpg", 540, 74),
  "assets/img/atelier.jpg": photo("atelier.jpg", 620, 74),
  "assets/img/logo.png": dataUri(p("assets/img/logo.png"), "image/png"),
  "assets/img/icone-32.png": dataUri(p("assets/img/icone-32.png"), "image/png"),
  "assets/img/icone-180.png": dataUri(p("assets/img/icone-180.png"), "image/png"),
};
...
const sortie = p("atelier-genot.embed.html");
...
writeFileSync(p("atelier-genot.artifact.html"), fragment);
...
console.log(`atelier-genot.embed.html    — ${Math.round(statSync(sortie).size / 1024)} Ko`);
console.log(`atelier-genot.artifact.html — ${Math.round(statSync(p("atelier-genot.artifact.html")).size / 1024)} Ko`);
